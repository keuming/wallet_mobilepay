...
import { AirtimeLiteController } from './airtime-lite.controller';
...
@Module({
  ...
  controllers: [PaymentEngineController, AirtimeController, GiftCardsController, UtilityPaymentsController, AirtimeLiteController],
