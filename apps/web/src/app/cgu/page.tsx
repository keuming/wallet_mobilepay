  ...
  return (
    <div className="mp-container">
      ...
      <div className="mp-static-content">
        ...
        <h3>1. Objet</h3>
        <p>
          Les présentes conditions générales régissent l'utilisation de ORZAYAH, service de
        ...
        <p>
          L'ouverture d'un compte ORZAYAH est soumise à la vérification de l'identité de
        ...
        <p>
          ...
          et de son code secret transactionnel. ORZAYAH ne demande jamais ce code par téléphone,
          SMS ou email.
        </p>
        ...
        <p>
          Toute contestation de transaction doit être signalée via l'assistance ORZAYAH dans les
        ...
        <p>
          ORZAYAH se réserve le droit de modifier les présentes conditions générales. Les
